...
export interface ApiAllAll extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    categoryId: Schema.Attribute.Enumeration<
      ['Space', 'Brand', 'Object', 'Figure', 'Personal', 'Exhibitions', 'A letter from ', 'Frames']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::all.all'> &
      Schema.Attribute.Private;
    mainImage: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.Required;
    popupText: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Component<'project.sec', true> & Schema.Attribute.Required;
...
export interface ApiMainMain extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    mainImage: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.Required;
    popupText: Schema.Attribute.Text;
    projectID: Schema.Attribute.Integer & Schema.Attribute.Required & Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Component<'project.sec', true>;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
